#ifndef _LIBCF_MAT_IO_HPP__
#define _LIBCF_MAT_IO_HPP__
...
template <class Archive, typename _Scalar, int _Rows, int _Cols, int _Options>
    void save(Archive & ar, 
              const Eigen::Matrix<_Scalar, _Rows, _Cols, _Options> & m, 
...
template <class Archive, typename _Scalar, int _Rows, int _Cols, int _Options>
    void load(Archive & ar, 
              Eigen::Matrix<_Scalar, _Rows, _Cols, _Options> & m, 
              const unsigned int version) {
      int rows, cols;
      ar & rows;
      ar & cols;
